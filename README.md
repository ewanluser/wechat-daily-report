...
基于Electron的桌面应用，使用AI技术智能分析微信群聊和个人聊天内容，生成精美的日报。

![产品截图](public/images/product.png)

## ✨ 主要功能

- 🧠 **AI智能分析**：基于先进的AI技术分析群聊和个人聊天内容，自动识别重要信息
...
1. **选择聊天对象**：从下拉列表中选择要分析的群聊或个人聊天
   - 🗣️ 群聊：多人讨论分析
   - 👤 个人聊天：双人对话深度分析
2. **选择日期**：选择要分析的具体日期
3. **生成日报**：点击"生成日报"按钮开始AI智能分析
4. **导出分享**：生成的日报可以保存为图片或查看文本版本

## 🆕 个人聊天分析功能

我们最新推出了个人私人聊天记录的分析功能！

### ✨ 个人聊天特色功能
- 🔍 **关系基调分析**：识别友好型、专业型、亲密型、中性型等不同的交流基调
- 💭 **对话模式识别**：分析问答式、分享式、讨论式、支持性等沟通模式
- ❤️ **情感洞察**：深度挖掘情绪变化、关怀表达、话题偏好等情感信息
- 🎨 **沟通风格描述**：个性化的表达习惯和语言使用偏好分析

### 📊 专属分析维度
个人聊天日报包含独特的分析维度，如关系互动模式、情感倾向趋势、个性化沟通建议等，为您提供更深入的双人对话洞察。

### 📚 使用指南
详细的个人聊天功能使用说明请参考：[个人聊天日报功能使用指南](docs/PRIVATE_CHAT_GUIDE.md)
...
- 💝 **个人聊天指南**：[个人聊天日报功能使用指南](docs/PRIVATE_CHAT_GUIDE.md)
